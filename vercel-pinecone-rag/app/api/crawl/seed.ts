...
export async function seed(
  ...
  try {
    ...
    // Prepare documents by splittling the pages
...
async function prepareDocument(
  ...
  // Split the documetns using the provided splitter
...
async function embedDocument(doc: Document): Promise<PineconeRecord> {
  try {
    ...
    return {
      ...
      values: embeddings, // The vector values are the OpenAI embeddings
      metadata: {
        // The metadata includes datails about the document
        chunk: doc.pageContent, // The chunk of text the vector represents
